"""Shared helpers for the idea_3a_cached pre-extracted frame cache.
...
This is a verbatim copy of idea_3i/frame_cache.py; the on-disk format is
identical, so a cache produced by idea_3i/pre_extract_videos.py (at any frame
count) can be read here.
"""
