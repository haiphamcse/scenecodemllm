"""In-training VSI-Bench generation metrics (idea_3i_spatialstack).

Fork of idea_3i/callbacks.py without the placeholder blocks: video frames come
from the pre-extracted cache and ``raw_videos`` is passed at generation time so
the layered VGGT geometry fusion is active at eval.
"""
