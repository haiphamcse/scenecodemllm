...
#
#   scripts/idea_4a_sg_perc_scannetv2_vgjson_video/eval_vgllm_metric.sh                  # latest ep6 ckpt
#   scripts/idea_4a_sg_perc_scannetv2_vgjson_video/eval_vgllm_metric.sh --limit 5        # smoke
#   RUN=results/idea_4a_sg_perc_scannetv2_vgjson_lora \
#     scripts/idea_4a_sg_perc_scannetv2_vgjson_video/eval_vgllm_metric.sh \
...
RUN="${RUN:-results/idea_4a_sg_perc_scannetv2_vgjson_video_lora}"
...
exec "${PYTHON}" idea_4a_sg_perc_scannetv2_vgjson_video/eval_vgllm_metric.py \
  --run "${RUN}" \
  "$@"
