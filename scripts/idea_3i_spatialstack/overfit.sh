...
OUTPUT_DIR="results/overfit/idea_3i_spatialstack_overfit"
...
accelerate launch --config_file common/multi_gpu.yaml --num_processes "${NPROC_PER_NODE}" idea_3i_spatialstack/train.py "${args[@]}" "$@"
