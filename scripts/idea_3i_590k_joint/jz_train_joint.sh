...
#
#   python idea_3i_590k_joint/build_mix.py --vqa_rows 300000 --det_rows 100000
#
...
#   bash scripts/idea_3i_590k_joint/jz_train_joint.sh
...
OUTPUT_DIR="${SR_OUTPUT_ROOT:-results}/idea_3i_590k_joint"
...
accelerate launch --config_file common/multi_gpu.yaml \
  ...
  idea_3i_590k_joint/train.py "${args[@]}" "$@"
