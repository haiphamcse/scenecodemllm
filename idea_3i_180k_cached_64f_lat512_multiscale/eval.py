...
# The live MULTISCALE model (VGGT-Omega inside, shared frame Perceiver over the 4 cached
# depths) is common/model_with_vggt_live_multiscale.py; this fork's model_with_vggt.py is
# the cached variant and shares the module name.
_spec = importlib.util.spec_from_file_location(
    "model_with_vggt_live_multiscale", _COMMON / "model_with_vggt_live_multiscale.py")
