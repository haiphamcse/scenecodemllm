...
ReVSI clips are filtered; VSI-Bench clips are asserted absent. Output rows:
(task, video, conversations, question_type, source). Then filter_mix_es.py (det_es + drop list),
then build_mix_190k.py (the training mix, vqa_train_190k_es_clean.jsonl).

  python idea_3i_180k_es_64f_lat512_clean/build_mix_180k.py --vsi_jsonl ... --vlm3r_dir ... \
      --data_root ... --revsi_dir ... --vsib_dir ... --out .../idea_3i_dataset_jsons/vqa_train_180k.jsonl
"""
...
# VLM-3R question templates -> VSI-590K question_type values.
_TYPE_RULES = [
