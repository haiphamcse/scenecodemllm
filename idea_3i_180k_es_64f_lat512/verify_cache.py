...
(decoded-video) cache.
  ...
  python idea_3i_180k_es_64f_lat512/verify_cache.py --mix_jsonl ... --vggt_cache_root ... [--old_cache_root ...]
"""
import argparse
import json
import random
...
from collator import det_es_frames, task_of  # noqa: E402
...
def main():
    ...
    vqa = sorted({r["video"] for r in rows if task_of(r) != "det"})
