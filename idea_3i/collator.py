...
if __name__ == "__main__":
    ...
    # Optional argv[1]: comma-separated VSI-590K sources (default = legacy scannetppv2).
    sources = tuple(sys.argv[1].split(",")) if len(sys.argv) > 1 else None
    print(f"building datasets ... sources={sources or '(legacy scannetppv2)'}")
    train_dataset = build_train_dataset(jsonl_path, sources)
